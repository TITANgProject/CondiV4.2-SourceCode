...
#define ATK_VEC_STOMP      2
#define ATK_VEC_ACK        3
#define ATK_VEC_TCPNULL    4
#define ATK_VEC_STDHEX     5
#define ATK_VEC_TCP        6
#define ATK_VEC_NUDP       7
#define ATK_VEC_SYNDATA    8
#define ATK_VEC_SACK2      9
...
#define ATK_OPT_MC              26
#define ATK_OPT_RAND_LEN        27  // random packet len
